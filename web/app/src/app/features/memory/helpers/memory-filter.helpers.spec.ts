...
describe('memory-filter.helpers', () => {
  ...
  it('converts inclusive calendar dates to RFC3339 API bounds', () => {
    const api = toApiFilters({ ...DEFAULT_MEMORY_VIEW_FILTERS, minDate: '2026-02-01', maxDate: '2026-02-28' });
    expect(api.min_date).toBe('2026-02-01T00:00:00.000Z');
    expect(api.max_date).toBe('2026-02-28T23:59:59.999Z');
  });
