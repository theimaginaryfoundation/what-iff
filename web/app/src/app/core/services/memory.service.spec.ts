...
describe('MemoryService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [provideZonelessChangeDetection(), provideHttpClient(withXhr()), provideHttpClientTesting(), MemoryService],
    });
  ...
  describe('getMemories', () => {
    ...
    it('sends chat_id, level, scope, type, pinned_personality_id, query, status, sort, min_date, max_date', () => {
      service
        .getMemories(1, 10, {
          chat_id: 'chat-1',
          level: 'personality',
